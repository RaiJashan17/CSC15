...
public class Homework5{
	public static void main(String[] args){
		...
		System.out.println(Double.toString(fahrenheitConvert(212.0f)));		// Answer should be 100.0
	...
	public static double fahrenheitConvert(float fahrenheit){
	...
	public static String lieDetector(boolean isTrue){
		...
		String answer;
		if (isTrue==true)
			answer="You are telling the truth";
		else
